...
jQuery(function () {
  ...
  jQuery('body')
    ...
    .append('<script src="' + tp + '/assets/js/libs/bootstrap-alert.min.js"><\/script>')
    .append('<script src="' + tp + '/assets/js/libs/bootstrap-tab.min.js"><\/script>')
    .append('<script src="' + tp + '/assets/js/libs/bootstrap-dropdown.min.js"><\/script>')
    .append('<script src="' + tp + '/assets/js/libs/bootstrap-modal.min.js"><\/script>')
