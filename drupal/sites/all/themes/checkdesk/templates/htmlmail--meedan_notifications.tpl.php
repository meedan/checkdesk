...
$image = empty($logo_path) ? '' : image_style_url('thumbnail', $logo_path),
...
<?php if ($image) : ?>
<img id="logo"  src="<?php print $image ?>" style="box-sizing: border-box; display: block; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; margin: 0 auto; max-width: 100%; padding: 10px; width: 60%" />
<?php endif; ?>
		</td>
