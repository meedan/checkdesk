...
angular.module('ngTranslate').provider('$translate', function () {
  var $translationTable = {}, $uses, $rememberLanguage = false, $missingTranslationHandler, $asyncLoaders = [];
  var LoaderGenerator = {
      forUrl: function (url) {
        return [
          '$http',
  ...
  this.$get = [
    ...
    function ($interpolate, $log, $injector, $cookieStore, $rootScope, $q, $COOKIE_KEY) {
      ...
      // HACK: Expose the translationTable so it can be used by the experimental cdTranslationUI
      $translate.translationTable = $translationTable;
